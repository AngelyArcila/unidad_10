...
<head>
    ...
    <link rel="stylesheet" href="css/general.css"> <!--faltaba linea-->
...
<body>
    <a href="index.html#section-respuestas">
        <img class="home" src="img/home2.png" alt="HOME"> <!--faltaba texto alt-->
    </a>
    <div class="main-frame-cal">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="n2" class="form-control" id="exampleFormControlInput2" placeholder="Digite número 2"> <!-- faltaba name-->
            </div>
            <div class="form-group">
                <label for="exampleFormControlSelect1">Seleccione la operación:</label>
                <select class="form-control" name="tipo" id="exampleFormControlSelect1">
                    <option value="1">Suma</option>
                    <option value="2">Resta</option> <!-- faltaba value-->
